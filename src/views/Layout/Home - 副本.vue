	...
	<el-row class="container">
		...
		<el-col :span="24" class="main">
			<aside class="el-scrollbar" :class="collapsed?'menu-collapsed':'menu-expanded'">
				<!--导航菜单-->
				<el-menu :default-active="$route.path" class="el-menu-vertical-demo with-auto el-scrollbar__wrap" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" @open="handleopen" @close="handleclose" @select="handleselect"
				...
				<!--导航菜单-折叠后-->
				<ul class="el-menu el-menu-vertical-demo collapsed el-scrollbar__wrap" v-show="collapsed" ref="menuCollapsed" style="overflow-x: hidden;margin-bottom: -17px;margin-right: -17px;background: #545c64;color:#fff;">
...
<style scoped lang="scss">
	...
	.container {
		...
		.main {
			...
			.with-auto{width: auto !important; overflow-x: hidden; margin-bottom: -17px;margin-right: -17px;}
		}
	}
</style>